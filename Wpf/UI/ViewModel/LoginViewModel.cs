...
namespace UI.ViewModel
{
    ...
    public partial class LoginViewModel : NavigationAware
    {
        ...
        readonly SQLite _db;
        readonly Model.UserSession _session;
        readonly Rapper.AppNavigator _navigator;
        ...
        public LoginViewModel(ILogger<LoginViewModel> logger, SQLite db, Model.UserSession session, Rapper.AppNavigator navigator)
        {
            _logger = logger;
            _db = db;
            _session = session;
